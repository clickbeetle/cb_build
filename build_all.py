...
os.system("/home/shrinidhi/bin/gitHub/cb_build/stage3.py --root=/BACKUP/clickbeetleCook.DO_NO_DELETE/cb_build/"+ str(uuid) +" --pkgs app-portage/gentoolkit,sys-apps/gptfdisk,app-portage/eix,app-admin/sudo,sys-process/time,net-misc/bridge-utils,sys-apps/usermode-utilities")
print uuid