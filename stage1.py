...
try:
  ...
  stage1Cmd1 = "USE=\"-* "+ os.environ['USE'] +" build\" emerge --binpkg-respect-use=n --deep --buildpkg=y --quiet-build=y --root="+ Root +" --with-bdeps=y --config-root="+ configRoot +" sys-apps/baselayout dev-lang/python:2.7 dev-lang/python:3.2 dev-lang/python:3.3"
